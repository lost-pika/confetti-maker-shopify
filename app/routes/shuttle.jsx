...
export default function ConfettiApp() {
  ...
  // Initialize with empty arrays so the saved section is initially empty
  ...
  // Updated to allow overriding the type (defaulting to activeDraftTab)
  const handleCreateNew = (typeOverride) => {
    const type = typeof typeOverride === 'string' ? typeOverride : activeDraftTab;
    ...
    switch (burstType) {
      ...
      case 'snow':
        ...
        window.confetti({
          ...
          origin: { x: 0.5, y: -0.1 },
          colors: ['#7dd3fc', '#38bdf8', '#c084fc', '#818cf8'], 
          shapes: ['circle'],
          gravity: 0.4,
          scalar: 0.8,
          drift: 0,
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans">
      <div className="px-8 py-10 max-w-6xl mx-auto">
        ...
        {/* Updated Banner Section - Centered Layout */}
        <div className="bg-white rounded-xl border border-slate-200 p-10 flex flex-col items-center justify-center text-center gap-6 shadow-sm mb-10">
          <div>
            <h2 className="text-3xl font-bold mb-2 text-slate-900">Start a New Celebration</h2>
            <p className="text-slate-600 text-sm max-w-md mx-auto leading-relaxed">
              Design custom confetti explosions or voucher reveals for your customers.
            </p>
          </div>
          <button 
        ...
        <div className="grid grid-cols-3 gap-6 mb-10">
          {[
            ...
            { value: savedVouchers.length, label: 'Vouchers Created' },
          ...
          <div className="space-y-3">
            {filteredList.length > 0 ? (
              ...
              <div className="text-center py-12 border-2 border-dashed border-slate-200 rounded-xl">
                ...
                <p className="text-slate-400 text-xs mt-1">Create a new {activeDraftTab} to see it here.</p>
              </div>
            )}
          </div>
        </section>
